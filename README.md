...
source failures captured during gateway runs. The decision audit report
aggregates ingest, drop, quarantine, skip, dry-run and error reasons from source
audit JSONL files, plus score ranges and averages for operator review. The
