...
historical snapshots; this document describes the current v1.1.1 behavior.

## Version Status

| Label | Meaning | Current value |
| --- | --- | --- |
| Latest published release | Latest immutable GitHub Release and stable tag | `v1.1.1`, published 2026-09-14 |
| Previous stable release | Previous GitHub Release and immutable tag | `v1.1.0`, published 2026-09-06 |
| v1.1.1 publication | GitHub Release, tag and image publication | Complete |
...
complete public release. The v1.1.1 tag, GitHub Release, release notes, image
...
The v1.1.1 evidence record is maintained in `release-v1.1.1.md`. A green unit
