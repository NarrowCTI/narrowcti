...
| `NARROWCTI_OPERATIONAL_VALIDATION_EVIDENCE_FILE` | Optional compose-runner helper for the v0.8 operational validation service. It points to a local JSON file with operator-recorded manual checks such as full validation, OpenCTI duplicate review and resource posture. |
