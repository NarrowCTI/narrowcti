...
| Detection rule | `indicator` | Exportable as pattern-aware Indicator for YARA, Sigma, Snort, Suricata and PCRE; final OpenCTI placement polish is pending after real MISP validation. |
