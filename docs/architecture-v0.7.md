...
| MISP metadata evidence | Implemented for collector, original source, tags, TLP markings, EventReport note evidence, CVE vulnerability evidence and common Galaxy/Cluster graph evidence. |
...
| MISP rich mapping | Expand object relations, sightings, NVD vulnerability enrichment and richer taxonomy tags beyond the initial EventReport, CVE and Galaxy/Cluster audit mapping. |
