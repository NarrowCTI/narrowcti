...
| MISP metadata evidence | Implemented for collector, original source, tags, TLP markings, CVE vulnerability evidence and common Galaxy/Cluster graph evidence. |
...
| MISP rich mapping | Expand object relations, sightings, EventReport notes, NVD vulnerability enrichment and richer taxonomy tags beyond the initial CVE and Galaxy/Cluster audit mapping. |
