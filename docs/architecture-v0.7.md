...
| Area | Current state |
| --- | --- |
| OTX entity extraction | Implemented for actor, malware family, ATT&CK, sector, country, TLP, references and tags. |
| MISP metadata evidence | Implemented for collector, original source, tags, TLP markings and common Galaxy/Cluster graph evidence. |
...
| MISP rich mapping | Expand object relations, sightings, EventReport notes, CVE/vulnerability context and richer taxonomy tags beyond the initial Galaxy/Cluster audit mapping. |
