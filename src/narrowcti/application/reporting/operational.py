"""Provider-neutral operational reporting semantics."""
...
from narrowcti.domain.review.quarantine import (
    EXPIRED, PARTIALLY_RELEASED, PENDING, REJECTED, RELEASED, normalize_status,
)

QUARANTINE_STATUS_ORDER = (PENDING, RELEASED, PARTIALLY_RELEASED, REJECTED, EXPIRED)
...
__all__ = [
    "GatewayOperationalReport", "build_operational_report", "build_quarantine_review",
    "empty_quarantine_statuses", "empty_totals", "merge_totals", "merge_query_summaries",
    "sorted_query_summaries", "build_value_metrics", "failure_record", "percentage",
    "format_text_report", "render_report", "normalize_output_format", "format_totals",
    "format_metrics", "format_quarantine_statuses", "QUARANTINE_STATUS_ORDER",
]
