"""Provider-neutral curation reporting semantics."""
...
REDACTION_POLICIES = {
    "none": {
        ...
        "removed_fields": [],
        "retained_sections": [
            "executive_summary", "operational", "decisions", "analyst_review",
            "analyst_review_actions", "source_summaries", "context_sections",
            "graph_validation", "policy_insights", "recommendations",
        ],
    },
    "support": {
        "audience": "support",
        ...
        "aggregate_only": True,
        "removed_fields": [
            "operational.failures", "operational.queries",
            "operational.sources.*.failures", "decisions.quarantined", "decisions.queries",
        ],
        "retained_sections": [
            "executive_summary", "source_summaries", "context_sections",
            "graph_validation", "policy_insights", "recommendations",
        ],
    },
    "external": {
...
__all__ = [
    ...
    "recommendation",
    "graph_evidence_has_held_reason",
    "empty_graph_validation_summary",
    "build_graph_validation_summary",
    "compact_audit_target",
    "sorted_text_values",
    "build_review_action_summary",
    "empty_review_action_summary",
    "empty_score_summary",
    "empty_graph_evidence_summary",
    "empty_context_quality_summary",
    "empty_context_narrative_summary",
    "build_graph_evidence_summary",
    "build_context_quality_summary",
    "build_context_narrative_summary",
    "build_context_sections",
    "build_context_section",
    "context_section_entry",
    "context_section_top_entities",
    "context_section_shared_entities",
    "context_entity_type_priority",
    "build_source_summaries",
    "source_posture",
    "build_policy_insights",
    "normalize_count_key",
    "normalize_reason",
    "top_reason_entries",
    "top_category_entries",
    "top_count_entries",
    "source_action_reason_entries",
    "flatten_source_reasons",
    "percent",
    "ratio",
    "graph_preview_int",
    "report_to_dict",
    ...
    "format_text_values",
    "format_context_section_summary",
    "format_mapping_counts",
    "format_category_entries",
    "format_narrative_entries",
    "format_count_entries",
    "format_optional",
    "SCHEMA_VERSION", "REDACTION_PROFILES", "CONTEXT_SECTION_DEFINITIONS", "REDACTION_POLICIES",
]
